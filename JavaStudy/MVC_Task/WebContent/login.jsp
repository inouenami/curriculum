...
<%
    ...
    Function<HttpServletRequest, Object[]> rmdGetResponseInfo = (rmdRequest) -> {
        ...
        String empId = (String)request.getAttribute("");
...
<link rel="styleSheet" type="text/css" href=".css/commn.css">
<link rel="styleSheet" type="text/css" href="./css/login.css">
<script type="text/javascript" src="js/common.js" /></script>
<title>ログイン</title>
</head>
<body>
	<input id="hiddenDialog" type="hidden"
		value="<%=requestStatus == 2 ? message : ""%>"></input>
	<h2>ログイン</h2>
	<div class="div-login-form">
		...
		<form action="/MVC_Task/employee" method="post">
			<div class="div-input-flex-area">
				<div>
					<label>社員番号 : </label> <input id="empId" type="text" name="empId"
						maxlength="5" value="<%=empId%>"><br>
				</div>
				<div>
			...
			<div class="div-button-area">
				...
				<button id="btn-login" class="btn-login" name="requestType"
					value="login">ログイン</button>
			</div>
		</form>
	</div>
</body>
